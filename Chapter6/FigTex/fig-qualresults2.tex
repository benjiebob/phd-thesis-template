...
\includegraphics[trim=0cm 1cm 8.15cm 1cm,clip,width=1.0\linewidth]{exps/qual_results_all/qualfigs_3.png}
...
\centering
% \resizebox{.95\linewidth}{!}{
\includegraphics[trim=8.15cm 1cm 0cm 1cm,clip,width=1.0\linewidth]{exps/qual_results_all/qualfigs_3.png}
% }
% \vspace{-1.15cm}
\caption{%
