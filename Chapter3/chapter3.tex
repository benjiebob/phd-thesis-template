...
Recent works have almost entirely adopted convoluational neural network (CNN) based architectures for supervised 2D keypoint prediction tasks. An early example combined a CNN with neighbourhood component analysis  (a supervised classification algorithm functionally equivalent to k-nearest neigbours)  classification . 
