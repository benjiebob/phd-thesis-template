...
% - Discuss methods for generating accurate synthetic data, particularly focus on SURREAL. Possibly define a GAN and discuss.
% - Create experiments in which different methods are trained and tested on varying levels of fake data. Argue why not to use a GAN?
...
% (2) Use a GAN to generate synthetic data?
