...
\begin{figure}[t]
\input{Chapter4/fig_splash_cr.tex}\medbreak
\caption{
...
While the dominant paradigm in human reconstruction is now end-to-end deep learning methods, SPIN~\cite{kolotouros2019learning} show impressive improvement by incorporating an energy minimization process within their training loop to further minimize a 2D reprojection loss subject to fixed pose \& shape priors. Inspired by this innovation, we learn an iteratively-improving shape prior by applying expectation maximization during the training process.
...
On the other hand, animal silhouette data is plentiful~\cite{mscoco,everingham2010pascal,DAVIS2017-2nd}.
...
\input{Chapter4/fig_system_overview2.tex}
...
\input{Chapter4/fig_scalingparams.tex}
...
\input{Chapter4/tab_baselines.tex}
\input{Chapter4/fig_comparison_sup2.tex}
...
\input{Chapter4/fig_qualresults_sup.tex}